...
import { XIcon, UploadCloudIcon, FileTextIcon, TrashIcon, LogOutIcon, CameraIcon, SettingsIcon, PlusCircleIcon } from './Icons';
    ...
    return (
        <div className="min-h-screen bg-[#050508] text-white p-4 md:p-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                {/* Coluna Aulas */}
                <div className="lg:col-span-2 bg-white/5 p-8 rounded-[3rem] border border-white/5 shadow-2xl relative overflow-hidden">
                    <div className="flex items-center justify-between mb-8">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <span className="text-[10px] font-black opacity-30 uppercase tracking-widest">{context.aulas.length} Aulas</span>
                        </div>
                    </div>
                    ...
                    <div className="overflow-x-auto">
                        ...
                        {context.aulas.length === 0 && !context.loading && (
                            <div className="py-20 text-center opacity-20 flex flex-col items-center gap-4">
                                <PlusCircleIcon className="w-12 h-12 stroke-[1px]" />
                                <p className="text-xs font-black uppercase tracking-[0.2em]">Nenhum registro encontrado. Faça upload do CSV para começar.</p>
                            </div>
                        )}
                    </div>
                </div>
...
const AdminScreen: React.FC<{ onReturnToDashboard: () => void }> = ({ onReturnToDashboard }) => {
    ...
    if (!auth) return (
        <div className="h-screen w-screen flex items-center justify-center bg-[#020205] p-6 relative overflow-hidden">
            ...
            <div className="bg-white/5 p-12 rounded-[4rem] border border-white/10 w-full max-w-sm text-center shadow-2xl backdrop-blur-3xl relative z-10">
